      ...
      header('location:../index.php');
        ...
        $student=$conn->query($slct) or die($conn->error);
         ...
         foreach ($raws as $key => $value) {
           # code...
          array_push($_SESSION['std'], $value);
         }
         //print_r($_SESSION['std']);


          $sql="SELECT * FROM industry WHERE industrysupervisor=".$_SESSION['staffid']."";
...
<!--        <div class="row"></div>-->
     <div class="row">
         ...
         <div class="col-sm-8 offset-md-2 text-center">
             <div class="jumbotron">
                 <div class="display-4">Industrial  Supervisor Dashboard</div>
                  <div class="lead">This is a Industrial Training Monitoring and Evaluation System</div>
                 <hr class="my-4">
                 <p>Welcome to Industrial Supervisor dashboard</p>
                 <hr />
