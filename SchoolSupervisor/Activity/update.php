    ...
    include_once $filePath;
      if($_SERVER['REQUEST_METHOD']=='GET'){
            ...
            if(isset($_POST['update'])){
                ...
                $sql="UPDATE training SET schoolremarks='".$_POST['school']."',assessment='Assessed' WHERE id='".$_POST['id']."'";
                if($conn->query($sql)){
                ...
                <div class="form-group  text-center">
                  ...
                  <div class="form-group  ">
                     ...
                     <?php if(!empty($row['industryremarks'])){
                      echo '<label >School Supervisor Remarks</label><textarea  readonly class="form-control  " rows="5"  name="industry">'.$row['industryremarks'].'</textarea>';

                     } ?>
                  </div>
                  <!-- remarks here -->
                  <div class="form-group  ">
                      <label >School Supervisor Remarks</label><textarea   class="form-control text-primary" rows="5"  name="school"><?php echo $row['schoolremarks']; ?></textarea>
