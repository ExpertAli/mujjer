    ...
    include_once $filePath;
      if($_SERVER['REQUEST_METHOD']=='GET'){
            ...
            if(isset($_POST['update'])){
                ...
                $sql="UPDATE report SET feedback='".$_POST['feedback']."' WHERE id='".$_POST['id']."'";
                if($conn->query($sql)){
     ...
     <div class="row justify-content-center mx-5 pb-2" style="background: #ccc;">
              ...
              <form class="form col-8" action="" method="post">
                <div class="form-group  text-center">
                  ...
                  <textarea class="form-control" readonly rows="10" name="summary"><?php echo $row['summary']; ?></textarea>
                  </div>

                  <div class="form-group  ">
                      <label >School Supervisor Feedback</label>
                     
                  <textarea class="form-control text-primary" rows="10" name="feedback"></textarea>
                  </div>
