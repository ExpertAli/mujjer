  ...
  if(!file_exists($filePath)){
    ...
    include_once $filePath;
      if(isset($_POST['register'])){
          ...
          $sql="INSERT INTO student(fullname,birthdate,sex,email,password,phonenumber,programme,course) VALUES('".$_POST['fullname']."','".$_POST['birthdate']."','".$_POST['sex']."','".$_POST['email']."','".md5($_POST['password'])."','".$_POST['phone']."','".$_POST['programme']."','".$_POST['course']."')";
         ...
         <!-- <div class="col-sm-8 offset-md-2 mt-2 text-center bg-light"> -->
              ...
              <form class="form col-8" action="" method="post">
                <div class="form-group  ">
                      <label ><h1 class="text-primary border-bottom border-dark"> STUDENT REGISTRATION</h1> </label>
                  </div>
                  <div class="form-group  ">
