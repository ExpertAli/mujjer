      ...
      if(isset($_POST['login']) && !empty($_POST['login'])){
       // print_r($_POST);
        ...
        if($result->num_rows == 1){
          ...
          $error['staff']= '<div class="alert alert-danger px-5 py-2 mx-5">Incorrect Email and Password! Please Try Again</div>';
        }
  ...
  <body>
    <div class="container-fluid px-3" style="min-height: 100%">
      ...
      <div class="row text-center bg-light py-3">
         ...
         <h2 class="col text-danger"><?php echo ucfirst($_GET['user']); ?> Login Page</h2>
         
      </div>
      <?php echo $error['staff']; ?>
      <div class="row justify-content-center " >
        ...
        <form class="form col-6"  action="" method="POST">
          ...
          <div class="form-group text-right">
            <input type="user" class="form-control" name="user" value=<?php echo ucfirst($_GET['user']); ?> hidden>
